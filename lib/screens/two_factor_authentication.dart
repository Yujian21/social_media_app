...
class _TwoFactorAuthenticationPageState
                ...
                if (documents[0]['isAuthenticated'] == true) {
                  ...
                  WidgetsBinding.instance!.addPostFrameCallback((_) {
                    ...
                    context
                        ...
                        .toggleIsDoubleAuthenticated(context);
 ...
 // if (pin.length == 6) {
                          ...
                          //       final docRef = biothenticatorFirestore
                          //           .collection('2fa-status')
                          //           .doc(FirebaseAuth.instance.currentUser!.uid)
                          //           .collection('attempts')
                          //           .doc(authDocID);
                          ...
                          //           snapshot);
                          //     } else {
                          //       // If the fallback PIN was incorrect
                          //       _generateAlertDialog(context, 'Incorrect PIN',
                          //           'The PIN provided was incorrect.');
                          //     }
                          //   });
                          // } else {
                          //   // If the fallback PIN was in an invalid format (Length wise)
                          //   _generateAlertDialog(context, 'Invalid PIN',
                          //       'The PIN provided was invalid.');
                          // }
